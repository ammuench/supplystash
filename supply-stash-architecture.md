...
- **NativeWind** — Tailwind for React Native; the same class strings compile on native and web
...
│  ┌──────────────────┐  ┌───────────────────────────┐  │
│  │ RNR + NativeWind │  │  state/ hooks  (the only  │  │
...
1. **NativeWind breakpoints** (`sm:` / `md:` / `lg:`) — these work on native as well as web, driven by window width. Handles ~90% of it.
...
│       ├── global.css             # NativeWind / Tailwind layer
│       ├── app.config.ts
│       └── tailwind.config.js
├── packages/
...
| UI Components                            | React Native Reusables + NativeWind                                                                                                                               | Tailwind classes shared across native and web; simpler than Tamagui, fast to move in                                                                                                                                                                                                                                           |
...
| Web                                      | React Native Web at launch, degraded features                                                                                                                     | Same codebase, responsive via NativeWind breakpoints. No scan, no push, **no persistence**, and the check-off is online-only. §5.4                                                                                                                                                                                             |
