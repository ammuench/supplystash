...
ALTER TABLE "user_homes" ADD CONSTRAINT "user_homes_home_id_homes_id_fk" FOREIGN KEY ("home_id") REFERENCES "public"."homes"("id") ON DELETE cascade ON UPDATE no action;